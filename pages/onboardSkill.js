    ...
    <div className="container-fluid">
      <div className="row">
        <div className="col-lg-8">
          ...
          <TabsNavSkills addSkill={addSkill} selectedSkills={selectedSkills}></TabsNavSkills>
          <div className="text-end">
            <Link href="/admin" onClick={() => submitSkills()} className="btn btn-outline-primary mt-5">Continuer</Link>
          </div>
        </div>
            ...
            {selectedSkills.map((e, i) =>
              <AnimatePresence key={i}>
                <motion.div
                  ...
                  onClick={() => addSkill(e)}
                >
                  <Image src={e.url} alt={e.name} className="p-3" width={100} height={100} />
                </motion.div>
              </AnimatePresence>
            )}
          </div>
